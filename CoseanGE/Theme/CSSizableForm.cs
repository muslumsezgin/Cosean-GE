...
{
    public partial class CSSizableForm : Form
    {
        public CSSizableForm()
        {
            InitializeComponent();
        }
            ...
            if (isTopPanelDragged)
            {
                ...
                if (this.Location.X > 2 || this.Location.Y > 2)
                {
                    if (this.WindowState == FormWindowState.Maximized)
                    {
                        ...
                        _MaxButton.CFormState = CSFullScreenButton.CustomFormState.Normal;
        ...
        private void TopPanel_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            if (this.Location.Y <= 5)
            {
                if (!isWindowMaximized)
                {
                    ...
                    _MaxButton.CFormState = CSFullScreenButton.CustomFormState.Maximize;
